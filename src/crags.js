...
const BigCannonCliff = {
    ...
    guidebook: "https://docs.google.com/document/d/18SPGo4IxsBq9iFy81ke-uDGK8QnE1L6oZCaPvV-B0Ic/",
...
const GuanZiLing = {
    ...
    guidebook: "A copy of the Guan Zi Ling Guidebook by Hung-Hsiang Wang can be purchased from Alpine Direct by following the link below. Alternatively you can purchase a copy from the Red Rock Bouldering Gym in Shilin.",
    guidebookURL: "http://www.alpinedirect.com.tw/ProductShow.asp?ProductID=306&KindHeadID=25",
...
const ShouShan = {
    ...
    guidebook: "A guidebook called Rock Climbing Taiwan put together by Nate Ball provides useful topos of each of the routes listed below. A copy of Rock Climbing Taiwan can be accessed below. Scroll down to page 23 for the start of the Shou Shan chapter.",
    guidebookURL: "https://docs.google.com/document/d/18SPGo4IxsBq9iFy81ke-uDGK8QnE1L6oZCaPvV-B0Ic/edit",
