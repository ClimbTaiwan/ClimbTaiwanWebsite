const LongDong = {
    ...
    imgURL: "../docs/Images/longDong.jpg",
    rocks: [
        {
            name: "Back Door - B1",
            routes: [
...
const BigCannonCliff = {
    ...
    imgURL: "../docs/Images/BigCannonCliff.jpg",
    rocks: [
        {
            name: "All Routes",
            routes: [
...
const GuanZiLing = {
    ...
    mapHTML: '',
    mobileMapHTML: '',
    imgURL: "../docs/Images/GuanZiLing.jpg",
    rocks: []
}
...
const ShouShan = {
    ...
    mapHTML: '',
    mobileMapHTML: '',
    imgURL: "../docs/Images/ShouShan.jpg",
    rocks: []
}
