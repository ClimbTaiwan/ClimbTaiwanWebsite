export const ShouShan = {
    ...
    travel: "From the Longquan Temple Trail Entrance (龙泉寺登山口, GPS coordinates 22.655417, 120.273204), walk along the boardwalk for about 10 minutes to the first split at a pavilion. Stay right here and continue for another 4 minutes to another fork. Go left (uphill) and continue for another 12 minutes to another fork. There will be a sign about snakes, a sign-post, a map, and an obvious bare trail going off to the right. Follow this, staying left on the most obvious trail, until you cut left along a narrow path that quickly arrives at the entrance of Skyline. Continue past this and turn left, following a faint path through the jungle to Hobo Wall and White Wall. Turn right slightly further along to reach AC Wall and eventually Dirty Wall.",
    guidebook: [
      {
